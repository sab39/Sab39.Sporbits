...
/// </remarks>
public sealed class PlayerInputController(PlayerPlanet planet, float strength) : InputControllerBase
{
    public PlayerPlanet Planet { get; } = planet;
    public float Strength { get; } = strength;

    public override void Update(float dt) => Planet.Body.ApplyForce(MovementDirection * Strength);
}
