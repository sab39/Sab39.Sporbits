...
/// <summary>
/// A goal a long way to the right, and a steady stream of rubble coming the other way.
/// </summary>
/// <remarks>
...
public sealed class AsteroidStreamLevel : ISporbitsLevel
{
    ...
    public void Populate(SporbitsSpace space)
    {
        ...
        // Far enough right that the stream has plenty of chances at you on the way.
